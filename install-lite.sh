...
################################################################################
# MDVSEC Lite - Simplified Access Point Setup
...
print_header() {
    ...
    echo -e "${BRIGHT_CYAN}║${NC}   ${DIM}v1.4.0-lite${NC} ${DIM}|${NC} ${DIM}Arch:${NC} ${CYAN}$(uname -m)${NC} ${DIM}|${NC} ${DIM}OS:${NC} ${CYAN}$(lsb_release -si)${NC}   ${BRIGHT_CYAN}║${NC}"
    echo -e "${BRIGHT_CYAN}╚═══════════════════════════════════════════════════════╝${NC}"
    echo ""
}
